	...
	return (
		...
		<footer className='text-gray-400 text-sm z-20 fixed bottom-0 left-0 right-0 flex flex-col items-center w-full max-w-6xl mx-auto px-4'>
			...
			<div
				...
				className='w-full bg-neutral-900/95 backdrop-blur-sm border-t border-gray-700'>
				<div className='max-w-6xl mx-auto px-4 py-4 flex flex-col gap-4'>

					{/* Hint colour key */}
					<div>
						<p className='text-xs uppercase tracking-widest text-gray-200 mb-3'>Hint colours</p>
						<ul className='flex flex-wrap justify-center gap-x-6 gap-y-3'>
							...
							<li className='flex items-center gap-2'>
								<div className='w-6 h-6 rounded bg-red-700 shrink-0 flex items-center justify-center text-white text-xs font-bold'>↑</div>
					...
					<div>
						<p className='text-xs uppercase tracking-widest text-gray-200 mb-3'>MTG colours</p>
						<ul className='flex flex-wrap justify-center gap-x-6 gap-y-3'>
							<li className='flex items-center gap-2'>
